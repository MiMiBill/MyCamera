...
//    private static final String TAG = "JCameraView";
    ...
    // 原项目中的码率明显偏低
    // 实际推荐码率有大致比例 分辨率=宽*高，分辨率*1为低码率，*2为中等码率，*4为高码率
    //录制视频比特率
    ...
    private int themeColor = 0; //对焦和进度颜色
    ...
    private String mRecordSoShortTip="录制时间过短";
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        themeColor = a.getColor(R.styleable.JCameraView_themeColor, 0xEE16AE16);
        a.recycle();
        initData();
        initView();
    }
    ...
    private void initView() {
        ...
        mCaptureLayout.setProgressColor(themeColor);
        mCaptureLayout.setIconSrc(iconLeft, iconRight);
        mCaptureLayout.setCancelColor(0xFF666666, 0xAAFFFFFF);
        mCaptureLayout.setConfirmColor(themeColor, 0xFFFFFFFF);

        mFocusView = view.findViewById(R.id.fouce_view);
        mFocusView.setColor(themeColor);
        ...
        mCaptureLayout.setCaptureListener(new CaptureListener() {
            ...
            public void recordShort(final long time) {
                mCaptureLayout.setTextWithAnimation(mRecordSoShortTip);
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void resetState(int type) {
        ...
        mSwitchCamera.setVisibility(VISIBLE);
//        mFlashLamp.setVisibility(VISIBLE);
        CameraInterface.getInstance().setFlashVisible();
    ...
    public String getRecordSoShortTip() {
        return mRecordSoShortTip;
    }

    public void setRecordSoShortTip(String recordSoShortTip) {
        mRecordSoShortTip = recordSoShortTip;
    }
