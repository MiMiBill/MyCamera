...
//                resetCaptureLayout();
    ...
    public void setCancelColor(int contentColor, int bgColor) {
        btn_cancel.setColor(contentColor, bgColor);
    }

    public void setConfirmColor(int contentColor, int bgColor) {
        btn_confirm.setColor(contentColor, bgColor);
    }
}
